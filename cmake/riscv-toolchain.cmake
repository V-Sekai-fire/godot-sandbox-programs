...
# Only use RISC-V toolchain when NOT in embedded/native mode
# When EMBEDDED_RISCV=ON, use host compiler for native builds
if (NOT EMBEDDED_RISCV)
    ...
    # Embedded/native mode: use host compiler, not RISC-V cross-compiler
    message(STATUS "EMBEDDED_RISCV=ON: Using host compiler for native builds (no RISC-V toolchain required)")
endif()
